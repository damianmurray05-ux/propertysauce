...
4. **Where prospective tenants are stored.** Settled by Damian on 20 September 2026: not in Zoho. Applicants live in the Google Sheet "Applicants database" in Drive (My Drive/Claude/01 Property Sauce/Lettings), one row per enquiry, emailed from lettings@propertysauce.co; a Zoho Tenant record is created only when the agreement is signed (Ops 01 and Ops 02).
