...
const routes = { "/api/chat": chat, "/api/chat/": chat, "/api/verify": verify, "/api/verify/": verify, "/api/scorecard": scorecard, "/api/scorecard/": scorecard, "/api/landlord": landlord, "/api/landlord/": landlord };
