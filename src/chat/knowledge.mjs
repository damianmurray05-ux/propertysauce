...
- After the report: the team reviews it the same working day, instructs a contractor, and the contractor arranges access with the tenant. Timescales depend on urgency: emergencies within 24 hours, urgent (affects health, safety or security, or will worsen) within a few working days, routine within a reasonable period, typically a couple of weeks. [Exact service levels to be confirmed by the team.]
...
- Damp and mould: always take it seriously. Ask for photographs, whether it is worsening, and whether there is a leak. Under Awaab's Law arrangements the landlord must investigate and act to fixed timescales. [Property Sauce internal timescales to be confirmed.]
...
- Deposit: at most five weeks' rent, protected in a government-approved scheme within 30 days, with the prescribed information given to the tenant. [Which scheme Property Sauce uses to be confirmed.]
- Holding deposit: at most one week's rent, refunded or credited to the first payment. It can be kept only if the applicant withdraws, fails right to rent, or gives false information.
...
- Inspections: periodic, with at least 24 hours' written notice, at a reasonable time. [Frequency to be confirmed; Sure Lets & Manage inspects every six months.]
...
- Private landlords: fully managed, rent collection or let only. Fees quoted in writing after an appraisal. [Fee schedule to be confirmed.]
