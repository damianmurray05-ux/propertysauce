...
export function mapProperty(rec) {
  ...
  return {
    ...
    gas: rec.Gas_Safe_Certificate || "", gasApplicable: !/no gas|n\/a|not applicable/i.test(String(rec.Gas_Safety_Applicable || "")) && !/no gas/i.test(String(rec.Pay_As_You_Go_Gas || "")),
